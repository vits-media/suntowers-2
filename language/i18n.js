...
const resources = {
  ...
  zh: {
    translation: {
      ...
      howHear: "如何了解到我们",
      ifOther: "其他（请注明）",
      homeType: "您想选择哪种户型？（选填）",
      oneBedroom: "一室",
      twoBedroom: "两室",
      threeBedroom: "三室",
      townhomeOrPenthouse: "联排屋或顶楼阁楼",
      budget: "您的预算是多少？（选填）",
      belowFive: "50万或更低",
      fiveToSevenFifty: "50万 - 75万",
      sevenFiftyToOneMil: "75万 - 100万",
      aboveOneMil: "100万或更高",
      workingWithRealtor: "您已经有自己的购房经纪人吗？（选填）",
      realtorName: "经纪人名名字（选填）",
      realtorPhone: "经纪人电话（选填）",
      realtorBrokerage: "经纪人所在公司：（选填）",
      realtor: "您是地产经纪吗",
      yes: "是",
      no: "否",
      online: "网页搜索",
